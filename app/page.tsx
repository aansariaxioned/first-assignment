  ...
  return (
    <div className=" space-y-16 p-2 @sm:p-10 wrapper pt-10">
      ...
      <section className="pt-10">
        ...
        <CardList items={infoItems} layout="list" className="border-0 shadow-none p-0 gap-0" />
      </section>

      <section className="pt-8">
        <h2 className="text-2xl font-bold mb-8">Location Card</h2>
        <h2 className="text-3xl font-semibold pb-5">New York</h2>
        <LocationCard items={locationData} className="border-0 shadow-none px-0 gap-0" />
      </section>
